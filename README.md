...
## Kurs og presentasjoner _holdt_
 - 2024: **Hvorfor coroutines ikke er en sølvkule på JVM: Livedemo**, Presentasjon med live koding av coroutines i Kotlin for utviklere, med fokus på hvorfor de ikke er en sølvkule for å løse samtidighet på JVM, og noen pitfalls man må være klar over om man skal bruke dem.
