...
## Kurs og presentasjoner _holdt_
 - 2025: **Backend-testing**, 40 minutters foredrag med hands-on kodeeksempler om testing av backend. Fokus på Vy Digital sin techstack med Spring, Kotlin, Postgres. Gjennomgang av testfilosofi, samt verktøy som Zonky, Testcontainers, Mockk, Intellij profiling, Intellij HTTP, mfl. Holdt for Vy Digital.
 - 2025: **Databasemigrering og katastrofehåndtering**, 60 minutter foredrag/workshop om databasemigrering og katastrofehåndtering i forbindelse med feilede migreringer og andre databaseproblemer, med fokus på Vy sine systemer på Postgres, Aurora Postgres og AWS. Holdt for Vy.
 - 2024: **Databaserammeverk for Kotlin**, Foredrag om forskjellige strategier for kommunikasjon med relasjonsdatabaser i Kotlin på JVM, med et nærmere fokus på Ktorm og Exposed. Holdt for Twoday og Vy.
...
{% include badgeawsdeveloperassociate.html %}
 - 2025: **Privacy Awareness 2025**, Twoday/Nanolearning
